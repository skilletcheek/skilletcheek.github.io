...
const ACTIVITIES = [
  // Markets
  { name: "Dallas Farmers Market", cat: "market", area: "Downtown Dallas", venue: "Dallas Farmers Market",
  ...
  { name: "Cowtown Farmers Market", cat: "market", area: "Fort Worth", venue: "Cowtown Farmers Market",
  ...
  { name: "Coppell Farmers Market", cat: "market", area: "Coppell", venue: "Coppell Farmers Market",
  ...
  { name: "Sundance Square Makers Market", cat: "market", area: "Fort Worth", venue: "Sundance Square",
  ...
  { name: "Dallas Museum of Art", cat: "arts", area: "Arts District, Dallas", venue: "Dallas Museum of Art",
    ...
    url: "https://dma.org" },
  { name: "Kimbell Art Museum", cat: "arts", area: "Fort Worth Cultural District", venue: "Kimbell Art Museum",
  ...
  { name: "The Modern — Free First Sunday", cat: "arts", area: "Fort Worth Cultural District", venue: "Modern Art Museum of Fort Worth",
  ...
  { name: "Nasher Sculpture Center", cat: "arts", area: "Arts District, Dallas", venue: "Nasher Sculpture Center",
  ...
  // Outdoors
  { name: "Klyde Warren Park", cat: "outdoors", area: "Downtown Dallas", venue: "Klyde Warren Park",
  ...
  { name: "Fort Worth Botanic Garden", cat: "outdoors", area: "Fort Worth", venue: "Fort Worth Botanic Garden",
    ...
    url: "https://fwbg.org" },
  { name: "Katy Trail Walk & Ride", cat: "outdoors", area: "Uptown Dallas", venue: "Katy Trail",
  ...
  { name: "White Rock Lake Loop", cat: "outdoors", area: "East Dallas", venue: "White Rock Lake Park",
    recur: { daily: true }, time: "Sunrise – Sunset", cost: 0,
  ...
  { name: "Live Jazz at Sandaga 813", cat: "music", area: "Deep Ellum, Dallas", venue: "Sandaga 813", venueUrl: null,
  ...
  { name: "The Balcony Club — Live Jazz & Blues", cat: "music", area: "Lakewood, East Dallas", venue: "The Balcony Club",
  ...
  { name: "Adair's Saloon — Honky-Tonk Nightly", cat: "music", area: "Deep Ellum, Dallas", venue: "Adair's Saloon",
  ...
  { name: "The Free Man — Live Jazz & Funk", cat: "music", area: "Deep Ellum, Dallas", venue: "The Free Man",
  ...
  { name: "Revelers Hall — Live Jazz Daily", cat: "music", area: "Bishop Arts, Oak Cliff", venue: "Revelers Hall",
  ...
  { name: "Swing Night at Sons of Hermann Hall", cat: "music", area: "Deep Ellum, Dallas", venue: "Sons of Hermann Hall",
  ...
  { name: "Billy Bob's Texas — Live Country", cat: "music", area: "Fort Worth Stockyards", venue: "Billy Bob's Texas",
  ...
  { name: "Sundance Square Live", cat: "music", area: "Downtown Fort Worth", venue: "Sundance Square",
  ...
  { name: "Deep Ellum Live Music Crawl", cat: "nightlife", area: "Deep Ellum, Dallas",
    ...
    url: "https://deepellumtexas.com" },
  { name: "Trivia Night at Community Beer Co.", cat: "nightlife", area: "Design District, Dallas", venue: "Community Beer Co.",
  ...
  // Food & drink
  { name: "Truck Yard Beer Garden", cat: "food", area: "Lower Greenville, Dallas", venue: "Truck Yard",
  ...
  { name: "Rahr & Sons Brewery Tour", cat: "food", area: "Near Southside, Fort Worth", venue: "Rahr & Sons Brewing",
  ...
  // Family
  { name: "Dallas Zoo", cat: "family", area: "Oak Cliff, Dallas", venue: "Dallas Zoo",
  ...
  { name: "Story Time at Half Price Books Flagship", cat: "family", area: "Northwest Dallas", venue: "Half Price Books Flagship",
    recur: { weekly: [6] }, time: "11:00 AM", cost: 0,
    desc: "Free Saturday children's story time at the enormous flagship bookstore.",
    url: "https://hpb.com" },
  { name: "LEGOLAND Discovery Center", cat: "family", area: "Grapevine", venue: "LEGOLAND Discovery Center Dallas/Fort Worth",
  ...
  { name: "Dallas Arboretum & Botanical Garden", cat: "outdoors", area: "East Dallas", venue: "Dallas Arboretum and Botanical Garden",
  ...
  { name: "Perot Museum of Nature and Science", cat: "family", area: "Victory Park, Dallas", venue: "Perot Museum of Nature and Science",
  ...
  { name: "Dallas World Aquarium", cat: "family", area: "Downtown Dallas", venue: "Dallas World Aquarium",
  ...
  { name: "Fort Worth Zoo", cat: "family", area: "Fort Worth", venue: "Fort Worth Zoo",
  ...
  { name: "Cedar Ridge Preserve Hiking", cat: "outdoors", area: "Cedar Hill", venue: "Cedar Ridge Preserve",
  ...
  { name: "Arbor Hills Nature Preserve", cat: "outdoors", area: "Plano", venue: "Arbor Hills Nature Preserve",
    recur: { daily: true }, time: "Sunrise – Sunset", cost: 0,
  ...
  { name: "Trinity River Audubon Center", cat: "outdoors", area: "Southeast Dallas", venue: "Trinity River Audubon Center",
  ...
  { name: "Topgolf The Colony", cat: "sports", area: "The Colony", venue: "Topgolf The Colony",
  ...
  { name: "Epic Waters Indoor Waterpark", cat: "family", area: "Grand Prairie", venue: "Epic Waters Indoor Waterpark",
  ...
  { name: "Six Flags Over Texas", cat: "family", area: "Arlington", venue: "Six Flags Over Texas",
  ...
  { name: "Grapevine Vintage Railroad", cat: "family", area: "Grapevine", venue: "Grapevine Vintage Railroad",
